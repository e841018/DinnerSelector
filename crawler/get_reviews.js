...
var save = function(frame){
	if(frame.children[2].className===''){
		...
		var guideID = window.location.href.match(/contrib\/([0-9]*)/)[1];
...
reviews = document.querySelector('#pane > div > div.widget-pane-content.scrollable-y > div > div > div.section-listbox.section-scrollbox.scrollable-y.scrollable-show > div.section-listbox');
